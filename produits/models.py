...
class Produit(models.Model):
    ...
    mode_payement = models.CharField(_('Mode De Payement'), max_length=100, default="Par carte")
...
class Order(models.Model):
    ...
    ordered = models.BooleanField(default=False)
    frais_de_livraison = models.IntegerField(_('Frais De Livraison'), default=150)
